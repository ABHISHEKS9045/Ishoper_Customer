                  ...
                  children: [
                            ...
                            children: [
                              ...
                              Container(child:   countBids == null
                               ...
                               child: countBids['latest_bid'].toString() != details.auctionData['reserve_price']
                                   ?
                                 Text(
                                 '${getTranslated("Current Bid", context)}: ${countBids['latest_bid']} SR',
                                 style: titilliumRegular.copyWith(
                                   color: color.Pricecolor,
                                   fontSize: Dimensions.FONT_SIZE_LARGE,
                                 ),
                                    ...
                                    Container(
                                      child: Column(
                                        ...
                                        children: [
                                          details.diff != null
                                              ? Text(
                                                  '${details.diff.isAfter(currentDateTime) ? "${getTranslated("UpComing In", context)}" : "${getTranslated("Ends In", context)}"}',
                                    ...
                                    countBids != null
                                        ? Container(
                                            child: countBids['bid_user_count'].toString() != null
                                                ? Text('${countBids['bid_user_count'].toString()} : ${getTranslated("Bids", context)}',
                                                    style: titilliumRegular.copyWith(
                                                      color: Colors.black,
                                                      fontSize: Dimensions.FONT_SIZE_DEFAULT,
                                                    ))
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          '${details.wishCount} ${getTranslated("wish Listed", context)}',
                          style: titilliumRegular.copyWith(
                            color: Theme.of(context).hintColor,
                            fontSize: Dimensions.FONT_SIZE_DEFAULT,
                          ),
