...
class AuctionProductImageView extends StatelessWidget {
  final productModel;
  AuctionProductImageView({@required this.productModel});
          ...
          child: productModel['images'] != null
              ? Container(
                  ...
                  child: Stack(children: [
                    ...
                    productModel["unit_price"] != null && productModel["discount"] != 0
                        ? Positioned(
                            left: 0,
                            top: 0,
                            child: Column(
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(color: color.colortheme, borderRadius: BorderRadius.only(bottomRight: Radius.circular(Dimensions.PADDING_SIZE_SMALL))),
                                  child: Text(
                                    '${PriceConverter.percentageCalculation(context, productModel["unitPrice"], double.parse(productModel["discount"].toString()), productModel["discountType"])}',
  ...
  List<Widget> _indicators(BuildContext context) {
    ...
    for (int index = 0; index < productModel["images"].length; index++) {
      indicators.add(TabPageSelectorIndicator(
        backgroundColor: index == Provider.of<ProductDetailsProvider>(context).imageSliderIndex ? color.colortheme : ColorResources.WHITE,
