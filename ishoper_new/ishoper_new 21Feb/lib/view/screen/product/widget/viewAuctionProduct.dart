...
class _viewAuctionProductListState extends State<viewAuctionProductList> {
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      ...
      print("model.auctionDataList[index]============>${model.auctionDataList}");
    });
  }
                                        ...
                                        children: [
                                          ...
                                          model.auctionDataList[index]["discount"]  != null && model.auctionDataList[index]["discount"] > 0
                                            ...
                                            PriceConverter.convertPrice(
                                                context, double.parse(model.auctionDataList[index]['unit_price'].toString())),
                                          ...
                                          Text(
                                            PriceConverter.convertPrice(
                                                context, double.parse(model.auctionDataList[index]['unit_price'].toString()) ,
                                                discountType: model.auctionDataList[index]['discount_type'],
                                                discount: double.parse(model.auctionDataList[index]['discount'].toString())),
                                            style:
                                  ...
                                  child: Center(
                                    child: Text(
                                      PriceConverter.percentageCalculation(
                                        context,
                                        double.parse(model.auctionDataList[index]['unit_price'].toString()),
                                        double.parse(model.auctionDataList[index]['discount'].toString()),
                                        model.auctionDataList[index]['discount_type'],),
                                      style: robotoRegular.copyWith(
                                          color: Theme.of(context).highlightColor,
                                          fontSize: Dimensions.FONT_SIZE_SMALL),
                                    ),
