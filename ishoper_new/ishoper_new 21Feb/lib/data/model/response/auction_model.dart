...
class AuctionProductModel {
  ...
  int _limit;
  int _offset;
  List<AuctionProduct> _products;

  AuctionProductModel(
      {int totalSize, int limit, int offset, List<AuctionProduct> products}) {
  ...
  List<AuctionProduct> get products => _products;

  AuctionProductModel.fromJson(Map<String, dynamic> json) {
    _totalSize = json['total_size'];
    _limit = json['limit'];
    _offset = json['offset'];
    if (json['products'] != null) {
      _products = [];
      json['products'].forEach((v) {_products.add(new AuctionProduct.fromJson(v));
      });
    }
  }
