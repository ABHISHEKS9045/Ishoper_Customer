...
class OrderRepo {
  static const String TAG = "OrderRepo";
  ...
  Future<ApiResponse> getOrderList() async {
    try {
      ...
      debugPrint("$TAG get Order List ===========> ${e.toString()}");
  ...
  Future<ApiResponse> getOrderDetails(String orderID, String languageCode) async {
    try {
      ...
      debugPrint("$TAG get Order Details ===========> ${e.toString()}");
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  }
  ...
  Future<ApiResponse> getShippingList() async {
    try {
      ...
      debugPrint("$TAG get Shipping List ===========> ${e.toString()}");
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  }
  ...
  Future<ApiResponse> placeOrder(String addressID, String couponCode, String billingAddressId, String orderNote) async {
    try {
      ...
      debugPrint("$TAG place Order ===========> ${e.toString()}");
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  }
  ...
  Future<ApiResponse> getTrackingInfo(String orderID) async {
    try {
      ...
      debugPrint("$TAG get Tracking Info ===========> ${e.toString()}");
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  }
  ...
  Future<ApiResponse> getShippingMethod(int sellerId) async {
    try {
      final response = sellerId == 1 ? await dioClient.get('${AppConstants.GET_SHIPPING_METHOD}/$sellerId/admin') : await dioClient.get('${AppConstants.GET_SHIPPING_METHOD}/$sellerId/seller');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      debugPrint("$TAG get Shipping Method ===========> ${e.toString()}");
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  }
  ...
  Future<http.StreamedResponse> refundRequest(int orderDetailsId, double amount, String refundReason, List<XFile> file, String token) async {
    ...
    _fields.addAll(<String, String>{'order_details_id': orderDetailsId.toString(), 'amount': amount.toString(), 'refund_reason': refundReason});
  ...
  Future<ApiResponse> getRefundInfo(int orderDetailsId) async {
    try {
      ...
      debugPrint("$TAG get Refund Info ===========> ${e.toString()}");
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  }
  ...
  Future<ApiResponse> getRefundResult(int orderDetailsId) async {
    try {
      ...
      debugPrint("$TAG get Refund Result ===========> ${e.toString()}");
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  }
  ...
  Future<ApiResponse> cancelOrder(int orderId) async {
    try {
      ...
      debugPrint("$TAG cancel Order ===========> ${e.toString()}");
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  }
}
