...
class OrderProvider extends ChangeNotifier {
  ...
  List<OrderModel> _customProductList;
  ...
  List<OrderModel> get outForDeliveryList => _outForDeliveryList != null
      ...
      : _outForDeliveryList;
  List<OrderModel> get customProductList => _customProductList != null
      ? _customProductList.reversed.toList()
      : _customProductList;
  ...
  // Future<void> getOrderdetailCustom() async {
  ...
  Future<void> getOrderList(BuildContext context) async {
    ...
    if (apiResponse.response != null &&
      ...
      apiResponse.response.data.forEach((order) {
        ...
        } else if (orderModel.orderStatus == AppConstants.DELIVERED && orderModel.isSeller=='seller') {
        ...
        } else if (orderModel.orderStatus == AppConstants.CUSTOMPRODUCT) {
          _customProductList.add(orderModel);
        }
      });
    } else {
  ...
  Future<List<OrderDetailsModel>> getOrderDetailsCustom(
      String orderID, BuildContext context) async {
    _orderDetails = null;
    _addOrderStatusErrorText = '';
    ApiResponse apiResponse =
        await orderListRepo.getOrderDetailsCustom(orderID);
