...
import 'package:sixvalley_vendor_app/view/screens/addProduct/product_details_screen.dart';
                        ...
                        child: Padding(
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              ...
                              Row(children: [
                                Text(
                                  PriceConverter.convertPrice(context, productModel.unitPrice, discountType: productModel.discountType, discount: productModel.discount).split('.')[0],
                                  style: robotoBold.copyWith(color: color.colorPrice),
                                ),
                                ...
                                Text(productModel.rating != null ? productModel.rating.length != 0 ? double.parse(productModel.rating[0].average).toStringAsFixed(1) : '0.0' : '0.0',
                                    style: robotoRegular.copyWith(
                                      color: Provider.of<ThemeProvider>(context).darkTheme ? Colors.white : color.colorRating,
                                      fontSize: Dimensions.FONT_SIZE_SMALL,
                                    )),
                                Icon(Icons.star, color: Provider.of<ThemeProvider>(context).darkTheme ? Colors.white : color.colorRating, size: 15),
                                ...
                                InkWell(
                                  ...
                                  child: Container( width: 15,height: 15,
                                      child: Image.asset(Images.edit,color:color.colortheme)),
                                ),
                                    ...
                                    showDialog(context: context, builder: (BuildContext context){
                                      return ConfirmationDialog(icon: Images.cross,
                                        ...
                                        onYesPressed: () {Provider.of<RestaurantProvider>(context, listen:false).isLoading?
                                          Center(child: CircularProgressIndicator(color: color.colortheme,valueColor: AlwaysStoppedAnimation<Color>(color.colorWhite),)):Provider.of<RestaurantProvider>(context, listen:false).deleteProduct(context ,productModel.id);
                                        }
