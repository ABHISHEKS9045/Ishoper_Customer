...
class OrderDetailsScreen extends StatelessWidget {
  ...
  void _loadData(BuildContext context, String type) async {
    ...
    Provider.of<OrderProvider>(context, listen: false)
        .getOrderDetailsCustom(orderId.toString(), context);
    Provider.of<OrderProvider>(context, listen: false)
        .initOrderStatusList(context, shippingType);
    Provider.of<DeliveryManProvider>(context, listen: false)
        .getDeliveryManList(orderModel, context);
  }
        ...
        return order.orderDetails != null
                        ...
                        children: [
                          ...
                          Provider.of<SplashProvider>(context, listen: false)
                              ...
                              ? Padding(
                                  ...
                                  child: orderType == 'POS'
                                      ? SizedBox()
                                      : Consumer<DeliveryManProvider>(builder:
                                          (context, deliveryMan, child) {
                                          return Row(
                                            children: [
                                              Expanded(
                                                child: Container(
                                                  ...
                                                  child:
                                                    ...
                                                    items: deliveryMan
                                                      ...
                                                      return DropdownMenuItem<
                                                        ...
                                                        child: Text(
                                                          value != 0
                                                              ? '${deliveryMan.deliveryManList[(deliveryMan.deliveryManIds.indexOf(value) - 1)].fName} ${deliveryMan.deliveryManList[(deliveryMan.deliveryManIds.indexOf(value) - 1)].lName}'
                                                              : getTranslated(
                                                                  'select_delivery_man',
                                                                  context),
                                                          style: TextStyle(
                                                      ...
                                                      deliveryMan
                                                          .assignDeliveryMan(
                                                              ...
                                                              deliveryMan
                                                                  ...
                                                                  .id);
                                                      debugPrint(
                                                          '==========deliveryman id====>$value  ====>${deliveryMan.deliveryManList[value - 1].id}');
                                                    },
                                                  ),
                                                ),
                                              ),
                          ...
                          Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color:
                                        color.colorthemedark.withOpacity(0.5),
                              ...
                              children: [
                                Text(getTranslated('shipping_address', context),
                                    style: titilliumSemiBold.copyWith(
                                        fontSize: 14)),
                                Text(
                                  '${getTranslated('name', context)} : ${orderModel.customer != null ? orderModel.customer.fName ?? '' : ""} ${orderModel.customer != null ? orderModel.customer.lName ?? '' : ""}',
                                  style: titilliumRegular,
                                ),
                                Text(
                                    '${getTranslated('address', context)} : ${orderModel.shippingAddressData != null ? jsonDecode(orderModel.shippingAddressData)['address'] : orderModel.shippingAddress ?? ''}',
                                    style: titilliumRegular),
                                Text(
                                    '${getTranslated('billing_address', context)} : ${orderModel.billingAddressData != null ? orderModel.billingAddressData.address : orderModel.billingAddress ?? ''}',
                                    style: titilliumRegular),
                                Text(
                                    '${getTranslated('phone', context)} : ${orderModel.customer != null ? orderModel.customer.phone ?? '' : ""}',
                                    style: titilliumRegular),
                                Text(
            ...
            : Center(
                child: CircularProgressIndicator(
                    color: color.colortheme,
                    valueColor:
                        AlwaysStoppedAnimation<Color>(color.colorthemedark)));
      }),
    );
  }
}
