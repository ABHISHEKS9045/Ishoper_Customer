...
class MenuBottomSheet extends StatelessWidget {
                ...
                children: [
                  InkWell(
                    onTap: () => Navigator.push(context,
                        MaterialPageRoute(builder: (_) => ProfileScreenView())),
                    child: Container(
                  ...
                  CustomBottomSheet(
                      image: Icons.monetization_on_rounded,
                      title: getTranslated('refund', context),
                      widget: RefundScreen()),
  ...
  Widget addproduct( context,title,image) {
    return InkWell(
      onTap: () {
