                      ...
                      children: [
                        ...
                        Row(children: [
                          ...
                          Container(
                            ...
                            // margin: EdgeInsets.symmetric(horizontal: Dimensions.PADDING_SIZE_SMALL),
                            decoration: BoxDecoration(
                              color:  color.colortheme.withOpacity(0.5),
                              borderRadius: BorderRadius.circular(12),
                              boxShadow: [BoxShadow(color: Colors.grey[Provider.of<ThemeProvider>(context, listen: false).darkTheme ? 800 : 200], spreadRadius: 0.5, blurRadius: 0.3)],
                            ),
                            child: Center(
              ...
              child: Row(children: [
                ...
                InkWell(
                  onTap: (){
                    ...
                    child: Text(getTranslated('view_all', context),style: TextStyle(fontSize: Dimensions.FONT_SIZE_DEFAULT,fontWeight: FontWeight.w400,color:color.colortheme,decoration: TextDecoration.underline,))),
