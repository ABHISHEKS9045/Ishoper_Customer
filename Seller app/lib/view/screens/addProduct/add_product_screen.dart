...
class AddProductScreen extends StatefulWidget {
  ...
  AddProductScreen(
      {this.product, this.category, this.addProduct, this.editProduct, this.productType});
  @override
                ...
                return widget.product != null && resProvider.editProduct == null
                    ? Center(
                        child: CircularProgressIndicator(
                          ...
                          valueColor:
                              AlwaysStoppedAnimation<Color>(color.colorWhite),
                        ),
                      )
                    : Column(
                        children: [
                          ...
                          InkWell(
                            onTap: () {
                              ...
                              if (_haveBlankTitle) {
                                showCustomSnackBar(
                                    getTranslated(
                                        'please_input_all_title', context),
                                    context);
                              } else if (_haveBlankDes) {
                                showCustomSnackBar(
                                    getTranslated(
                                        'please_input_all_des', context),
                                    context);
                              } else {
                                Navigator.push(
                                    context,
