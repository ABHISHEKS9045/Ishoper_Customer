...
class RestaurantRepo {
  ...
  Future<ApiResponse> addImage(File image, String type) async {
  ...
  Future<ApiResponse> addProduct(Product product, AddProductModel addProduct, Map<String, dynamic> attributes, List<String> productImages, String thumbnail, String metaImage,
      String token, bool isAdd, bool isActiveColor, from_time,to_time,to_date,from_date,product_type,start_price,reserve_price,increment_price,isActive) async {
    ...
    _fields.addAll(<String, dynamic>{
      ...
      'lang': ["en"],
      // 'lang[]': addProduct.languageList.length!=0 ? addProduct.languageList[0] : 'en',
      ...
      'shipping_cost': '0',
      "auction_from_date":from_date,   //yyyy-mm-dd
      "auction_to_date":to_date,
      "auction_from_time":from_time,
      "auction_to_time":to_time,
      "auction_start_price":start_price,
      "auction_increment_price":increment_price,
      "auction_reserve_price":reserve_price,
      "product_type": product_type,
      'auction_active' : isActive
    });
    print('${product_type.runtimeType}==========Addproduct _fields======>$_fields ');
