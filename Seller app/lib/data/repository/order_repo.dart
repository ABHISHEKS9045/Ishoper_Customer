...
class OrderListRepo {
  ...
  Future<ApiResponse> getOrderDetailsCustom(String orderID) async {
    try {
      final response = await dioClient.get(
          "https://mactosys.com/iShoper/api/v1/get-order-details/" + orderID);
      print("response     customDetailpage $response");
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
