...
import 'package:flutter_sixvalley_ecommerce/view/screen/home/widget/AuctionProductView.dart';
            ...
            children: [
              CustomScrollView(
                ...
                slivers: [
                          ...
                          child: Card(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                boxShadow: [BoxShadow(color: Colors.grey[Provider.of<ThemeProvider>(context).darkTheme ? 900 : 200], spreadRadius: 1, blurRadius: 1)],
                                borderRadius: BorderRadius.circular(Dimensions.PADDING_SIZE_Thirty_Five),
                              ),
                  ...
                  SliverToBoxAdapter(
                    child: Padding(
                      padding: EdgeInsets.fromLTRB(Dimensions.HOME_PAGE_PADDING, Dimensions.PADDING_SIZE_SMALL, Dimensions.PADDING_SIZE_DEFAULT, Dimensions.PADDING_SIZE_SMALL),
                      child: Column(
                        children: [
                          BannersView(),
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(color: HexColor("#FFBE81"), borderRadius: BorderRadius.all(Radius.circular(30))),
                            child: Column(
                              children: [
                                Column(
                                  children: [
                                    ...
                                    Text(
                                      ...
                                      style: TextStyle(color: Colors.white, fontFamily: "Inter", fontSize: 22.0, fontWeight: FontWeight.w600),
                                    ),
                                    SizedBox(
                                      height: 15.0,
                                    ),
                                    ...
                                    ElevatedButton(
                                        ...
                                        child: Text(
                                          "Post Your Product",
                                          style: TextStyle(color: color.colortheme, fontFamily: "Inter", fontSize: 18.0, fontWeight: FontWeight.w500),
                                        ))
                                  ],
                                ),
                                // SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                          ...
                          Consumer<FlashDealProvider>(
                            builder: (context, flashDeal, child) {
                              return (flashDeal.flashDeal != null && flashDeal.flashDealList != null && flashDeal.flashDealList.length > 0)
                                  ? TitleRow(
                          ...
                          // Brand
                          Padding(
                            padding: const EdgeInsets.only(left: Dimensions.PADDING_SIZE_EXTRA_SMALL, right: Dimensions.PADDING_SIZE_EXTRA_SMALL, bottom: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                            child: TitleRow(
                          ...
                          Consumer<FeaturedDealProvider>(
                            builder: (context, featuredDeal, child) {
                              return featuredDeal.featuredDealList == null && featuredDeal.featuredDealList.length > 0
                                  ? Container(height: 150, child: FeaturedDealsView())
                                  : (featuredDeal.featuredDealList != null && featuredDeal.featuredDealList.length > 0)
                                      ? Container(
                                          height: featuredDeal.featuredDealList.length > 4 ? 120 * 4.0 : 120 * (double.parse(featuredDeal.featuredDealList.length.toString())),
                                          child: Padding(
                                            padding: const EdgeInsets.only(bottom: Dimensions.HOME_PAGE_PADDING),
                          ...
                          //footer banner
                          Consumer<BannerProvider>(builder: (context, footerBannerProvider, child) {
                            return footerBannerProvider.mainSectionBannerList != null && footerBannerProvider.mainSectionBannerList.length > 0
                                ? Padding(
                                    padding: const EdgeInsets.only(bottom: Dimensions.HOME_PAGE_PADDING),
                          ...
                          SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                          Auctionviewproduct(scrollController: _scrollController),
                          SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                          ...
                          //footer banner
                          Consumer<BannerProvider>(builder: (context, footerBannerProvider, child) {
                            return footerBannerProvider.footerBannerList != null && footerBannerProvider.footerBannerList.length > 1 ? FooterBannersView(index: 1) : SizedBox();
                          }),
                          SizedBox(height: Dimensions.HOME_PAGE_PADDING),
                                    ...
                                    ? PopupMenuButton(
                                        itemBuilder: (context) {
                                          return [
                                            ...
                                            PopupMenuItem(
                                                value: ProductType.DISCOUNTED_PRODUCT,
                  ...
                  ? Positioned(
                      ...
                      child: Consumer<SplashProvider>(
                        builder: (context, announcement, _) {
                          return (announcement.configModel.announcement.announcement != null && announcement.onOff) ? AnnouncementScreen(announcement: announcement.configModel.announcement) : SizedBox();
                        },
                      ),
                    )
                  : SizedBox(),
