      ...
      child: Form(
        ...
        child: ListView(
          ...
          children: [
              ...
              child: Row(
                ...
                children: [
                  ...
                  InkWell(
                    ...
                    child: Text(getTranslated('FORGET_PASSWORD', context), style: titilliumRegular.copyWith(color: color.colortheme)),
                  ),
                ],
              ),
            ),
            ...
            // SocialLoginWidget(),
            // SizedBox(width: Dimensions.PADDING_SIZE_DEFAULT),
            Center(child: Text(getTranslated('OR', context), style: titilliumRegular.copyWith(fontSize: Dimensions.FONT_SIZE_DEFAULT))),
            GestureDetector(
              onTap: () {
              ...
              child: Container(
                margin: EdgeInsets.only(left: Dimensions.MARGIN_SIZE_AUTH, right: Dimensions.MARGIN_SIZE_AUTH, top: Dimensions.MARGIN_SIZE_AUTH_SMALL),
                ...
                child: Text(getTranslated('CONTINUE_AS_GUEST', context), style: titleHeader.copyWith(color: ColorResources.getPrimary(context))),
              ),
            ),
          ],
        ),
