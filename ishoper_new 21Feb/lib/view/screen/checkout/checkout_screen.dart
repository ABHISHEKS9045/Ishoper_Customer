...
import 'package:flutter_sixvalley_ecommerce/view/screen/payment/NewPaymentScreen.dart';
...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  void initState() {
    ...
    final model1 = Provider.of<CartProvider>(context, listen: false);
    final orderdata = Provider.of<ProfileProvider>(context, listen: false);
    adressData = orderdata.dataOrder;
    listcart = model1.cartDataList;
  }
                            ...
                            Navigator.pushReplacement(
                                ...
                                MaterialPageRoute(
                                    builder: (_) => NewPaymentScreen(
                                          Product: listcart[0],
                                          customerDetails: adressData[0],
                                          amount: (widget.totalOrderAmount + widget.shippingFee - widget.discount + widget.tax),
                                          tax: widget.tax,
                                          shippingFees: widget.shippingFee,
                                        )));
                          }
                        }
                      },
            ...
            child: ListView(physics: BouncingScrollPhysics(), padding: EdgeInsets.all(0), children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Expanded(child: Text('${getTranslated('shipping_address', context)}', style: titilliumRegular.copyWith(fontWeight: FontWeight.w600))),
                                InkWell(
                                  onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) => SavedAddressListScreen())),
                                  child: Image.asset(Images.address, color: color.colortheme, scale: 3),
                                ),
                              ],
                            ),
                            SizedBox(
                            ...
                            Column(
                              ...
                              children: [
                                Container(
                                  child: Text(
                                    Provider.of<OrderProvider>(context, listen: false).addressIndex == null ? '${getTranslated('address_type', context)}' : Provider.of<ProfileProvider>(context, listen: false).addressList[Provider.of<OrderProvider>(context, listen: false).addressIndex].addressType,
                                ...
                                Container(
                                  child: Text(
                                    Provider.of<OrderProvider>(context, listen: false).addressIndex == null ? getTranslated('add_your_address', context) : Provider.of<ProfileProvider>(context, listen: false).addressList[shipping.addressIndex].address,
                              ...
                              child: Column(
                                ...
                                children: [
                                  Row(
                                    ...
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Expanded(child: Text('${getTranslated('billing_address', context)}', style: titilliumRegular.copyWith(fontWeight: FontWeight.w600))),
                                      InkWell(
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Container(
                                        child: Text(
                                          Provider.of<OrderProvider>(context).billingAddressIndex == null
                                              ? '${getTranslated('address_type', context)}'
                                              : Provider.of<ProfileProvider>(context, listen: false).billingAddressList[Provider.of<OrderProvider>(context, listen: false).billingAddressIndex].addressType,
                                          style: titilliumBold.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE),
                                          maxLines: 1,
                                          overflow: TextOverflow.fade,
                                        ),
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              Row(
                                children: [
                                  ...
                                  Text(
                                    PriceConverter.convertPrice(context, Provider.of<CartProvider>(context, listen: false).cartList[index].price),
                              ...
                              Row(children: [
                                Text('${getTranslated('qty', context)} - ' + ' ' + Provider.of<CartProvider>(context, listen: false).cartList[index].quantity.toString(), style: titilliumRegular.copyWith()),
                              ]),
                            ]),
                          ),
                        ]),
              ...
              Padding(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      color: Colors.white,
                      //  ColorResources.couponColor(context)
                      //     .withOpacity(.5),
                      borderRadius: BorderRadius.circular(Dimensions.PADDING_SIZE_EXTRA_SMALL),
                      border: Border.all(width: .5, color: color.colortheme.withOpacity(.9))),
                  child: Row(children: [
                    Expanded(
                      child: SizedBox(
                        height: 50,
                        ...
                        ? InkWell(
                            ...
                            child: Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    borderRadius: BorderRadius.only(bottomRight: Radius.circular(Dimensions.PADDING_SIZE_EXTRA_SMALL), topRight: Radius.circular(Dimensions.PADDING_SIZE_EXTRA_SMALL))),
                                child: Center(
                                    child: Text(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Expanded(
                    ...
                    children: [
                      ...
                      _digitalPayment
                          ? Expanded(
                              child: Container(child: CustomCheckBox(title: getTranslated('digital_payment', context), index: !_cod ? 0 : 1)),
                            )
                          : SizedBox(),
                    ],
                  )),
