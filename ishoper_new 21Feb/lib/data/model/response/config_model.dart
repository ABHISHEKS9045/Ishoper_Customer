...
class ConfigModel {
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    _announcement = json['announcement'] != null ? new Announcement.fromJson(json['announcement']) : null;
...
class StaticUrls {
  ...
  StaticUrls({String contactUs, String brands, String categories, String customerAccount}) {
...
class Faq {
  ...
  Faq({int id, String question, String answer, int ranking, int status, String createdAt, String updatedAt}) {
    this._id = id;
...
class Colors {
  ...
  Colors({int id, String name, String code, String createdAt, String updatedAt}) {
    this._id = id;
    this._name = name;
    this._code = code;
    this._createdAt = createdAt;
