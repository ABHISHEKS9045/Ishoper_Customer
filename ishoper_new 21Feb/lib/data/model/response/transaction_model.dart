...
class TransactionModel {
  ...
  TransactionModel({int limit, int offset, double totalWalletBalance, int totalWalletTransactio, List<WalletTransactioList> walletTransactioList}) {
    if (limit != null) {
      this._limit = limit;
    }
    if (offset != null) {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this._walletTransactioList != null) {
      data['wallet_transactio_list'] = this._walletTransactioList.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class WalletTransactioList {
  ...
  WalletTransactioList({int id, int userId, String transactionId, double credit, double debit, double adminBonus, double balance, String transactionType, String reference, String createdAt, String updatedAt}) {
    if (id != null) {
      this._id = id;
    }
    if (userId != null) {
