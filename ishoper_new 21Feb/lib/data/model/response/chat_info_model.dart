class ChatInfoModel {
  ...
  ChatInfoModel({LastChat lastChat, List<ChatList> chatList, List<UniqueShops> uniqueShops}) {
    if (lastChat != null) {
  ...
  ChatInfoModel.fromJson(Map<String, dynamic> json) {
    _lastChat = json['last_chat'] != null ? new LastChat.fromJson(json['last_chat']) : null;
...
class LastChat {
  ...
  LastChat({int id, int userId, int sellerId, String message, int sentByCustomer, int sentBySeller, int seenByCustomer, int seenBySeller, int status, String createdAt, int shopId, SellerInfo sellerInfo, Shop shop}) {
    if (id != null) {
      this._id = id;
    }
    if (userId != null) {
  ...
  LastChat.fromJson(Map<String, dynamic> json) {
    ...
    _sellerInfo = json['seller_info'] != null ? new SellerInfo.fromJson(json['seller_info']) : null;
...
class Shop {
  ...
  Shop({int id, int sellerId, String name, String address, String contact, String image, String createdAt, String updatedAt, String banner}) {
    if (id != null) {
      this._id = id;
    }
    if (sellerId != null) {
...
class ChatList {
  ...
  ChatList({int id, int userId, int sellerId, String message, int sentByCustomer, int sentBySeller, int seenByCustomer, int seenBySeller, int status, String createdAt, String updatedAt, int shopId, String name, String image, SellerInfo sellerInfo, Shop shop}) {
    if (id != null) {
      this._id = id;
    }
    if (userId != null) {
...
class UniqueShops {
  ...
  UniqueShops({int id, int userId, int sellerId, String message, int sentByCustomer, int sentBySeller, int seenByCustomer, int seenBySeller, int status, String createdAt, int shopId, SellerInfo sellerInfo, Shop shop}) {
    if (id != null) {
      this._id = id;
    }
    if (userId != null) {
